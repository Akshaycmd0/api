...
router.get('/course-detail/Lid', checkAuth, (req, res) => {

    Course.findById(req.params.id)
        .select('_id courseName description price startingDate endDate imageUrl imageId')
        .then(result => {
...
// gett latest 5 course data
router.get('/latest-courses', cheakAuth, (req, res) => {
    const token = req.headers.authorization.split(" ")[1]
    const verify = jwt.verify(token, 'sbs online classes 123');
